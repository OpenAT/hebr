...
(function () {
    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.colorButton_colors = 'ffffff,000000,9e9e9e,ede1d5,bf0a30,';
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'hebr_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'hebr_tiny' } },
                {name: 'H1', element: 'h1'},
                {name: 'H2', element: 'h2'},
                {name: 'H3', element: 'h3'},
                {name: 'H4', element: 'h4'},
                ...
                // {name: 'Klein', element: 'span', attributes: { 'class': 'hebr_small_text' } },
                // {name: 'Sehr-Klein', element: 'span', attributes: { 'class': 'hebr_very_small_text' } },
            ];
